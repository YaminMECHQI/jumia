<div>
@if(!$open)
  <button wire:click="open" class="inline-flex px-4 py-2 m-2 font-bold text-white bg-green-500 rounded hover:bg-green-700">
...
<div>
    <form wire:submit.prevent="saveOrUpdate">
        ...
        <div class="col-span-6 m-4 sm:col-span-4">
            ...
            <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" wire:model.debounce.500ms="product.cover" id="cover" type="text" autocomplete="off">
        </div>
